...
class ClienteFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cpf' => ['type' => 'string', 'length' => 11, 'null' => false, 'default' => '', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'dt_nascimento' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'sexo' => ['type' => 'string', 'length' => 1, 'null' => false, 'default' => '', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_cliente_cidade' => ['type' => 'index', 'columns' => ['fk_id_cidade'], 'length' => []],
            'fk_cliente_uf' => ['type' => 'index', 'columns' => ['fk_id_uf'], 'length' => []],
        ],
        '_constraints' => [
